...
const About = (): JSX.Element => {
    return(
        <section className="bg-gradient-to-b from-[#010232] to-[#010232D4] text-white min-h-screen">
            <Navbar />
            <div className="sm:flex items-center justify-between pt-10">
               <div className="p-10 sm:mb-32 sm:w-1/2">
