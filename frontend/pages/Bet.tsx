    ...
    const renderButton = (): JSX.Element | undefined => {
        ...
        return(
            <div className="bg-gradient-to-b from-[#010232] to-[#010232D4] min-h-screen text-white">
                ...
                <div 
                className=
                "py-20 my-10 mx-10 border-2 rounded-3xl flex items-center justify-centers flex-col w-10/12 sm:w-9/12 md:w-8/12 lg:w-4/12  bg-gradient-to-b from-[#010232D4] via-[#0102328C] to-[#0771D38A]"
                >
