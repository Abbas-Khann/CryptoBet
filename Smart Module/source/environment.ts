...
import CryptoBetFactoryABI from '../artifacts/contracts/CryptoBetFactory.sol/CryptoBetFactory.json';
import CryptoBetABI from '../artifacts/contracts/CryptoBet.sol/CryptoBet.json';

export const FactoryABI = CryptoBetFactoryABI.abi as ContractInterface;
export const ContractABI = CryptoBetABI.abi as ContractInterface;
